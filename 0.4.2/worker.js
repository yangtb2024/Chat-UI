...
async function handleRequest(request) {
  if (request.method === 'POST') {
    ...
    <head>
      ...
      <link rel="icon" href="https://cdn.luogu.com.cn/upload/image_hosting/c57wl0lp.png"> 
      <style>
        body {
    ...
    <body>
      ...
      <script>
        ...
        function displayMessage(message, sender) {
          ...
          avatar.src = sender === 'user' ? 'https://cdn.luogu.com.cn/upload/usericon/211279.png' : 'https://cdn.luogu.com.cn/upload/usericon/915552.png';
